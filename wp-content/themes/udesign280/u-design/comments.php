...
<?php                   if ( is_user_logged_in() ) : ?>
                            <p><?php printf(__('Logged in as <a href="%1$s/wp-admin/profile.php">%2$s</a>.', 'udesign'), site_url(), $user_identity); ?> <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="<?php esc_html_e('Log out of this account', 'udesign'); ?>"><?php esc_html_e('Log out &raquo;', 'udesign'); ?></a></p>
<?php                   else : ?>
                            <p>
