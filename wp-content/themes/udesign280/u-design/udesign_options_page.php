	...
	function init_udesign_theme_options() {
		...
		add_option( "udesign_options",
		    array( // intitialize the 'udesign_options' array with the following key => value pairs:
			    ...
			    "title_headings_font_family" => "Tahoma",
			    ...
			    "recaptcha_lang" => "en",
			    "copyright_message" => '&copy; 2015 <strong>U-Design</strong>',
...
<?php					    do_meta_boxes($this->pagehook, 'additional', $options); ?>
					    <div class="submit-options-wrapper">
                                                <div class="submit">
                                                    ...
                                                    <input class="button-primary udesign-left-submit-btn" type="submit" name="form-submit" value="<?php esc_attr_e('Save Changes', 'udesign') ?>" />
...
<?php	}
	...
	function validate_options( $input ) {
		global $udesign_options, $google_webfonts, $portfolio_pages_array;
		...
		$input['font_size'] = ( $input['font_size'] ) ? $input['font_size'] : $udesign_options['font_size'];
                $input['body_font_line_height'] = ( is_numeric( $input['body_font_line_height'] ) && $input['body_font_line_height'] >= 0.2 && $input['body_font_line_height'] <= 5.0 ) ? abs($input['body_font_line_height']) : $udesign_options['body_font_line_height'];
		...
		$input['heading_font_size_coefficient'] = ( $input['heading_font_size_coefficient'] ) ? $input['heading_font_size_coefficient'] : $udesign_options['heading_font_size_coefficient'];
                $input['heading_font_line_height'] = ( is_numeric( $input['heading_font_line_height'] ) && $input['heading_font_line_height'] >= 0.2 && $input['heading_font_line_height'] <= 5.0 ) ? abs($input['heading_font_line_height']) : $udesign_options['heading_font_line_height'];
	...
	function help_options_contentbox( $options ) { ?>
		...
		<ul style="list-style-type:none; margin:5px 5px 10px 20px;">
		    <li><?php echo '<div><a href="'.get_template_directory_uri().'/scripts/documentation/index.html" title="Open the documentation" target="_blank">'.esc_html__('Documentation', 'udesign').'</a></div>'; ?></li>
				...
				<label for="logo_position_center">
				    ...
				    <?php esc_html_e('Center the logo instead of the default position on the left. ', 'udesign'); ?>
                                ...
                                <div class="submit" style="padding:10px 0 0 80px; float:right; clear:both;">
                                    <input type="hidden" id="udesign_submit" value="1" name="udesign_submit"/>
                                    <input class="button-primary udesign-right-submit-btn" type="submit" name="form-submit" value="<?php esc_attr_e('Save Changes', 'udesign') ?>" />
	...
	function layout_options_contentbox( $options ) { ?>
		  ...
		  <table class="form-table">
		    <tbody>
				    ...
				    <input type="hidden" id="udesign_submit" value="1" name="udesign_submit"/>
				    <input class="button-secondary udesign-left-submit-btn" type="submit" name="form-submit" value="<?php esc_attr_e('Update', 'udesign'); ?>" />
                                    <span class="spinner spinner-float-left"></span>
				</div>
				...
				<label for="font_size" style="float:left; width:100px;">
					...
					<select name="udesign_options[font_size]" id="font_size" style="padding-right:5px;">
					    ...
					    <option value="36"<?php echo ($options['font_size'] == '36') ? ' selected="selected"' : ''; ?>>36px</option>
                                ...
                                <div class="clear" style="margin-bottom: 10px;"></div>
				<label for="body_font_line_height" style="float:left; margin-right:7px; line-height:2;"><?php esc_html_e('Line Height: ', 'udesign'); ?></label>
                                <input name="udesign_options[body_font_line_height]" type="text" id="body_font_line_height" value="<?php echo ($options['body_font_line_height']) ? esc_attr($options['body_font_line_height']) : '1.7'; ?>" size="5" maxlength="4" />
...
<?php					    if( $options['enable_google_web_fonts'] == 'yes' ) {
				...
				<div style="clear:both;"><span class="description"><?php esc_html_e('The Font Size Coefficient is multiplied by the actual heading size in "em", thus any coefficient greater than "1.0" will cause the font size to inclease and any coefficient less than "1.0 will produce smaller font size.', 'udesign'); ?></span></div>
                                <div class="clear" style="margin-bottom: 10px;"></div>
				<label for="heading_font_line_height" style="float:left; margin-right:7px; line-height:2;"><?php esc_html_e('Line Height: ', 'udesign'); ?></label>
                                <input name="udesign_options[heading_font_line_height]" type="text" id="heading_font_line_height" value="<?php echo ($options['heading_font_line_height']) ? esc_attr($options['heading_font_line_height']) : '1.2'; ?>" size="5" maxlength="4" />
...
<?php		    display_save_changes_button(); ?>
			...
			<p><span class="description"><?php esc_html_e('A Color Scheme will be saved with an automatic name generated from the current time stamp. Once saved you will be able to choose it from the dropdown below and load it at a later time.', 'udesign'); ?></span>
				...
				<input type="hidden" id="udesign_submit" value="1" name="udesign_submit"/>
				<input class="button-secondary udesign-left-submit-btn" type="submit" name="form-submit" value="<?php esc_attr_e('Save', 'udesign'); ?>" />
                                <span class="spinner spinner-float-left"></span>
			    </div>
			</p>
			<div class="clear"></div>
	...
	function front_page_options_contentbox( $options ) {
		...
		<table class="form-table" style="background-color:#FCFCFC; border:1px solid #DDDDDD;">
			...
			<tr valign="top">
				...
				<div class="submit" style="padding:10px 0 0 80px; float:left; clear:both;">
				    <input type="hidden" id="udesign_submit" value="1" name="udesign_submit"/>
				    <input class="button-secondary udesign-left-submit-btn" type="submit" name="form-submit" value="<?php esc_attr_e('Save & Activate', 'udesign'); ?>" />
                                    <span class="spinner spinner-float-left"></span>
				</div>
...
<?php               if ( !is_plugin_active('revslider/revslider.php') ) : ?>
                        <div style="background-color:#FFEBE8; border:1px solid #C00; padding:0 0.8em; margin:10px 0;">
                            <p style="font-weight:bold;"><?php  printf( __('You need  to install the "Revolution Slider" first before using this feature. You may install the slider through the %1$sInstall Plugins%2$s section.', 'udesign'), '<a href="themes.php?page=tgmpa-install-plugins">', '</a>' ); ?></p>
                        </div>
<?php               else : ?>
                        <table class="form-table">
                            <tbody>
				    ...
				    <span class="description"><?php esc_html_e('Note: If a portfolio category has children categories those will also be excluded although they may not necessarily be assigned a portfolio page template themselves.', 'udesign'); ?></span>
                                ...
                                <div style="margin-left: 20px;">
                                    ...
                                    <label for="exclude_portfolio_from_main_query"><strong><?php esc_html_e('Main Query : ', 'udesign'); ?></strong> <br />
                                        ...
                                        <?php printf( esc_html__('Enabling this option will exlude portfolio categories and posts from the %1$sWordPress Main Query%2$s '
                                                . '(note that the %1$sRecent Posts%2$s widget will also be affected).', 'udesign'), 
                                                '<em>', '</em>'); ?>
                                    </label>
                                    </fieldset>
                                </div>
	    ...
	    echo ('
			...
			<tbody>
				...
				<td>
				    <div class="submit" style="padding:10px 0 0 80px; float:right; clear:both;">
					<input type="hidden" id="udesign_submit" value="1" name="udesign_submit"/>
					<input class="button-primary udesign-right-submit-btn" type="submit" name="form-submit" value="'.esc_attr__('Save Changes', 'udesign').'" />
                                        <span class="spinner"></span>
				    </div>
				</td>
			    </tr>
