...
<?php       else :
		...
		if ( is_category() ) { // If this is a category archive
			printf(__("<p class='center'>No entries were found under the %s category "
                                . "either because they were not published or this category has been excluded from the Blog section.</p>", 'udesign'), '<em>' . single_cat_title('',false) . '</em>');
