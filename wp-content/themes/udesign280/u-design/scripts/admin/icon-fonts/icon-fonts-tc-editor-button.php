            ...
            <table class="form-table">
                <tbody>
                    <tr valign="top">
                        ...
                        <td>
                            <div id="udesig-icon-fonts-select-wrapper">
                                <select id="udesig-icon-fonts-select" data-placeholder="Select an Icon">';
                                    <option value=""></option>
<?php                               if ( $udesign_fa_icons ) : ?>
                                        <optgroup label="<?php esc_html_e('Font Awesome Icons:', 'udesign'); ?>" class="fa-optgroup">
...
<?php                               if ( $udesign_fontello_icons ) : ?>
                                        <optgroup label="<?php esc_html_e('Fontello Icons:', 'udesign'); ?>" class="fontello-optgroup">
...
<?php   }
        ...
        jQuery(document).ready(function ($) {
            ...
            function addIcontoListItem(item) {
                ...
                return "<i class='" + $(classPrefix).data('css-prefix') + item.text + "'></i> " + item.text;
            }
            $("#udesig-icon-fonts-select").select2({
                placeholder: "Choose an Icon Font",
                allowClear: true,
                formatResult: addIcontoListItem,
                formatSelection: addIcontoListItem,
            ...
            $('#preview-icon-font-btn').on( "click", function() {
                ...
                var selectedIcon = $('#udesig-icon-fonts-select').val();
            ...
            function getTheIconFontCode( htmlOrShortcode ) {
                var selectedIcon = $('#udesig-icon-fonts-select').val();
                var selectedIsFontAwesome = $('#udesig-icon-fonts-select :selected').closest('optgroup').hasClass('fa-optgroup');
